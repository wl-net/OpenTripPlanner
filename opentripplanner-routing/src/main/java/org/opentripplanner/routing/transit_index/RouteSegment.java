 ...
 * patch the graph to remove the stop from the trip/pattern. This includes the pattern hop/dwell 
 * and board/alight edges, but not the edges common to all patterns/trips at this stop. 
 */
